...
tabeguache = Mountain.create(name: 'Tabeguache Peak', rank: 25, elevation: 14155, image: 'https://www.14ers.com/photos/shavanogroup/peakphotos/200507_Shav01.jpg?lu=20180101', mountain_range: sawatch)
...
gray_north = Route.create(name: 'North Slopes', trailhead: 'Grays Peak', difficulty: 1, gain: 3000, length: 7.5, mountain: grays)
torreys_south = Route.create(name: 'South Slopes', trailhead: 'Grays Peak', difficulty: 2, gain: 3000, length: 7.5, mountain: torreys)
west_evans = Route.create(name: 'West Ridge from Summit Lake', trailhead: 'Summit Lake', difficulty: 2, gain: 2000, length: 5.5, mountain: evans)
bierstadt_west = Route.create(name: 'West Slopes', trailhead: 'Guanella Pass', difficulty: 2, gain: 2850, length: 7.0, mountain: bierstadt)
longs_keyhole = Route.create(name: 'Keyhole Route', trailhead: 'Longs Peak', difficulty: 3, gain: 5100, length: 14.5, mountain: longs)
pikes_east = Route.create(name: 'East Slopes', trailhead: 'Manitou Springs', difficulty: 1, gain: 7600, length: 24.0, mountain: pikes)

quandary_east = Route.create(name: 'East Ridge', trailhead: 'Quandary', difficulty: 1, gain: 3450, length: 6.75, mountain: quandary)

lincoln_west = Route.create(name: 'West Ridge', trailhead: 'Kite Lake', difficulty: 2, gain: 2600, length: 6.0, mountain: lincoln)
cameron_west = Route.create(name: 'West Ridge', trailhead: 'Kite Lake', difficulty: 2, gain: 2250, length: 4.75, mountain: cameron)
bross_west = Route.create(name: 'West Slopes', trailhead: 'Kite Lake', difficulty: 2, gain: 2250, length: 3.25, mountain: bross)
democrat_east = Route.create(name: 'East Slope', trailhead: 'Kite Lake', difficulty: 2, gain: 2150, length: 4.0, mountain: democrat)
sherman_sw = Route.create(name: 'Southwest Ridge', trailhead: 'Fourmile Creek', difficulty: 2, gain: 2100, length: 5.25, mountain: sherman)

elbert_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Mt. Elbert North', difficulty: 1, gain: 4700, length: 9.5, mountain: elbert)
massive_east = Route.create(name: 'East Slopes', trailhead: 'Mt. Massive', difficulty: 2, gain: 4500, length: 14.5, mountain: massive)
harvard_south = Route.create(name: 'South Slopes', trailhead: 'North Cottonwood Creek', difficulty: 2, gain: 4600, length: 14.0, mountain: harvard)
columbia_west = Route.create(name: 'West Slopes', trailhead: 'North Cottonwood Creek', difficulty: 2, gain: 4250, length: 11.5, mountain: columbia)
plata_nw = Route.create(name: 'Northwest Ridge', trailhead: 'La Plata Peak', difficulty: 2, gain: 4500, length: 9.25, mountain: plata)
antero_west = Route.create(name: 'West Slopes', trailhead: 'Baldwin Gulch', difficulty: 2, gain: 5200, length: 16.0, mountain: antero)
shavano_east = Route.create(name: 'East Slopes', trailhead: 'Shavano/Tabeguache', difficulty: 2, gain: 4600, length: 9.0, mountain: shavano)
tabeguache_shav = Route.create(name: 'Via Mt. Shavano', trailhead: 'Shavano/Tabeguache', difficulty: 2, gain: 5600, length: 11.0, mountain: tabeguache)
belford_nw = Route.create(name: 'Northwest Ridge', trailhead: 'Missouri Gulch', difficulty: 2, gain: 4500, length: 8.0, mountain: belford)
oxford_bel = Route.create(name: 'Via Mt. Belford', trailhead: 'Missouri Gulch', difficulty: 2, gain: 5800, length: 11.0, mountain: oxford)
princeton_east = Route.create(name: 'East Slopes', trailhead: 'Mt. Princeton Road', difficulty: 2, gain: 3200, length: 6.5, mountain: princeton)
yale_sw = Route.create(name: 'Southwest Slopes', trailhead: 'Denny Creek', difficulty: 2, gain: 4300, length: 9.5, mountain: yale)
missouri_nw = Route.create(name: 'Northwest Ridge', trailhead: 'Missouri Gulch', difficulty: 2, gain: 4500, length: 10.5, mountain: missouri)
cross_north = Route.create(name: 'North Ridge', trailhead: 'Half Moon', difficulty: 2, gain: 5600, length: 12.0, mountain: cross)
huron_nw = Route.create(name: 'Northwest Slopes', trailhead: 'Clear Creek/Winfield', difficulty: 2, gain: 3500, length: 6.5, mountain: huron)

castle_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Castle Creek', difficulty: 2, gain: 4600, length: 13.5, mountain: castle)
conundrum_south = Route.create(name: 'South Ridge', trailhead: 'Castle Creek', difficulty: 2, gain: 4400, length: 13.5, mountain: conundrum)
maroon_south = Route.create(name: 'South Ridge', trailhead: 'Maroon Lake', difficulty: 3, gain: 4800, length: 12.0, mountain: maroon)
pyramid_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Maroon Lake', difficulty: 3, gain: 4500, length: 8.25, mountain: pyramid)
northmaroon_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Maroon Lake', difficulty: 4, gain: 4500, length: 9.25, mountain: northmaroon)
capitol_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Capitol Creek', difficulty: 4, gain: 5300, length: 17.0, mountain: capitol)
snowmass_east = Route.create(name: 'East Slopes', trailhead: 'Snowmass Creek', difficulty: 3, gain: 5800, length: 22.0, mountain: snowmass)

uncompahgre_south = Route.create(name: 'South Ridge', trailhead: 'Nellie Creek', difficulty: 2, gain: 3000, length: 7.5, mountain: uncompahgre)
wilson_north = Route.create(name: 'North Slopes', trailhead: 'Navajo Lake', difficulty: 4, gain: 3200, length: 6.5, mountain: mtwilson)
diente_north = Route.create(name: 'North Slopes', trailhead: 'Navajo Lake', difficulty: 3, gain: 3200, length: 6.0, mountain: diente)
wilsonpeak_sw = Route.create(name: 'Southwest Ridge', trailhead: 'Rock of Ages', difficulty: 3, gain: 3800, length: 10.0, mountain: wilsonpeak)
sneffels_south = Route.create(name: 'South Slopes', trailhead: 'Yankee Boy Basin', difficulty: 3, gain: 2900, length: 6.0, mountain: sneffels)
eolus_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Needleton', difficulty: 3, gain: 6100, length: 17.0, mountain: eolus)
windom_west = Route.create(name: 'West Ridge', trailhead: 'Needleton', difficulty: 2, gain: 6000, length: 17.0, mountain: windom)
sunlight_south = Route.create(name: 'South Face', trailhead: 'Needleton', difficulty: 4, gain: 6000, length: 17.0, mountain: sunlight)
northeolus_south = Route.create(name: 'South Ridge', trailhead: 'Needleton', difficulty: 3, gain: 6000, length: 17.0, mountain: northeolus)
handies_sw = Route.create(name: 'Southwest Slopes', trailhead: 'American Basin', difficulty: 1, gain: 2800, length: 7.5, mountain: handies)
redcloud_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Silver Creek/Grizzly Gulch', difficulty: 2, gain: 3700, length: 9.0, mountain: redcloud)
sunshine_red = Route.create(name: 'Via Redcloud Peak', trailhead: 'Silver Creek/Grizzly Gulch', difficulty: 2, gain: 4800, length: 12.25, mountain: sunshine)
wetterhorn_se = Route.create(name: 'Southeast Ridge', trailhead: 'Matterhorn Creek', difficulty: 3, gain: 3300, length: 7.0, mountain: wetterhorn)
luis_ne = Route.create(name: 'Northeast Ridge', trailhead: 'Stewart Creek', difficulty: 1, gain: 3600, length: 13.5, mountain: luis)

blanca_nw = Route.create(name: 'Northwest Ridge', trailhead: 'Lake Como', difficulty: 2, gain: 2700, length: 6.0, mountain: blanca)
ellingwood_south = Route.create(name: 'South Face', trailhead: 'Lake Como', difficulty: 2, gain: 2450, length: 6.0, mountain: ellingwood)
bear_west = Route.create(name: 'West Ridge and Southwest Face', trailhead: 'Lake Como', difficulty: 4, gain: 2300, length: 3.5, mountain: bear)
crestone_south = Route.create(name: 'South Face', trailhead: 'South Colony Lakes', difficulty: 3, gain: 6850, length: 20.0, mountain: crestone)
needle_south = Route.create(name: 'South Face', trailhead: 'South Colony Lakes', difficulty: 3, gain: 5550, length: 18.0, mountain: needle)
humboldt_west = Route.create(name: 'West Ridge', trailhead: 'South Colony Lakes', difficulty: 2, gain: 5350, length: 16.5, mountain: humboldt)
kit_challenger = Route.create(name: 'Via Challenger Point', trailhead: 'Willow Creek', difficulty: 3, gain: 6250, length: 14.5, mountain: kit)
challenger_north = Route.create(name: 'North Slope', trailhead: 'Willow Creek', difficulty: 2, gain: 5400, length: 12.5, mountain: challenger)
lindsey_nw = Route.create(name: 'Northwest Gully', trailhead: 'Huerfano/Lily Lake', difficulty: 3, gain: 3500, length: 8.25, mountain: lindsey)
culebra_nw = Route.create(name: 'Northwest Ridge', trailhead: 'Culebra', difficulty: 2, gain: 5450, length: 14.0, mountain: culebra)
